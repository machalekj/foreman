  ...
  def self.load_defaults
    ...
    self.transaction do
      [
        ...
        self.set('clean_up_failed_deployment', N_("Foreman will delete virtual machine if provisioning script ends with non zero exit code"), false, N_('Clean up failed deployment')),
